...
matmul_original_time = Time()
matmul_csr_encode_time = Time()
matmul_csr_mul_time = Time()
matmul_coo_encode_time = Time()
matmul_coo_mul_time = Time()
matmul_bsr_const_encode_time = Time()
matmul_bsr_const_mul_time = Time()
matmul_bsr_derived_encode_time = Time()
matmul_bsr_derived_mul_time = Time()
matmul_verify_time = Time()
